...
const Page = async () => (
  <div className="mx-auto flex min-h-[calc(100dvh-68px)] w-full max-w-5xl flex-col items-center justify-center gap-8 px-4 py-10">
    <PageHeader title="Upload Drill" subtitle="Custom JSON questions" />
    <UploadButton />
    <ExampleJsonInput />
    <div className="relative flex items-center justify-center gap-2 text-center text-sm text-secondary/70 dark:text-secondaryDark/70">
      Provide your JSON questions in the format above
